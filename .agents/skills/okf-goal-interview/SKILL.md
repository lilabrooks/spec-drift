...
description: Run the goal interview to fill docs/GOAL.md and AGENTS.md with the owner. Use when either file still has template brackets or missing goal content, before the first milestone task — also when the owner asks to define, redefine, or bootstrap the repo goal.
---

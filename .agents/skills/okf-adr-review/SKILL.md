...
2. Remove any "(proposed)" markers the ADR carries in the ADR index entries (`docs/adr/index.md` by default; a `layout:` block in `docs/okf-map.yml` may relocate it), `docs/GOAL.md` milestones, or the current-state line of `AGENTS.md`.

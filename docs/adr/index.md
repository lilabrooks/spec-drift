...
- [0004 Secret scanning in the quality gate](0004-secret-scanning.md): a dependency-free repo-local scanner blocks committed keys/tokens in the gate and CI, chosen over gitleaks/detect-secrets to keep the zero-dependency stance — **proposed**.

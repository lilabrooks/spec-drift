...
- [0007 Contradictory governing documents are reported, not resolved](0007-contradictory-documents.md): governing documents that disagree with each other yield insufficient-evidence naming the conflict, because ranking document types would silently pick a side — **proposed**.
